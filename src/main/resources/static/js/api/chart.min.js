...
!(function (t, e) {
        ...
        e.capBezierPoints &&
            (function (t, e) {
                ...
                for (i = 0, s = t.length; i < s; ++i)
                    ((a = o), (o = r), (r = i < s - 1 && Re(t[i + 1], e)), o && ((n = t[i]), a && ((n.cp1x = li(n.cp1x, e.left, e.right)), (n.cp1y = li(n.cp1y, e.top, e.bottom))), r && ((n.cp2x = li(n.cp2x, e.left, e.right)), (n.cp2y = li(n.cp2y, e.top, e.bottom)))));
            })(t, i);
    }
    const ci = (t) => 0 === t || 1 === t,
    ...
    function Ri(t, e, i) {
        ...
        const y = () => x || (l(n, b, p) && 0 !== r(n, b)),
            v = () => !x || 0 === r(o, p) || l(o, b, p);
        for (let t = c, i = c; t <= d; ++t) ((m = e[t % a]), m.skip || ((p = h(m[s])), p !== b && ((x = l(p, n, o)), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(Ei({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)), (i = t), (b = p))));
    ...
    class bo extends Js {
        ...
        getTickLimit() {
            ...
            return (
                s ? ((e = Math.ceil(this.max / s) - Math.floor(this.min / s) + 1), e > 1e3 && (console.warn(`scales.${this.id}.ticks.stepSize: ${s} would result generating up to ${e} ticks. Limiting to 1000.`), (e = 1e3))) : ((e = this.computeTickLimit()), (i = i || 11)),
                i && (e = Math.min(i, e)),
                e
            );
        }
    ...
    var ma = {
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            let o, a, r, l;
            for (a = 0; a < s; ++a)
                ((o = t.getDatasetMeta(a)), (r = o.dataset), (l = null), r && r.options && r instanceof no && (l = { visible: t.isDatasetVisible(a), index: a, fill: aa(r, a, s), chart: t, axis: o.controller.options.indexAxis, scale: o.vScale, line: r }), (o.$filler = l), n.push(l));
        ...
        _draw() {
            ...
            (this.legendItems.forEach((y, v) => {
                ...
                (r.setWidth(this.width),
                    b ? v > 0 && S + k + c > this.right && ((P = f.y += _), f.line++, (S = f.x = ft(n, this.left + c, this.right - i[f.line]))) : v > 0 && P + _ > this.bottom && ((S = f.x = S + e[f.line].width + c), f.line++, (P = f.y = ft(n, this.top + x + c, this.bottom - e[f.line].height))));
                if (
                    ((function (t, e, i) {
        ...
        getCaretPosition(t, e, i) {
            ...
            return (
                'center' === n
                    ...
                    : ((m = 'left' === s ? d + Math.max(r, h) + o : 'right' === s ? d + f - Math.max(l, c) - o : this.caretX), 'top' === n ? ((x = u), (_ = x - o), (p = m - o), (b = m + o)) : ((x = u + g), (_ = x + o), (p = m + o), (b = m - o)), (y = x)),
